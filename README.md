...
*   📦 [**fastansi-v0.1.0.jar**](https://github.com/andrestubbe/FastANSI/releases/download/v0.1.0/fastansi-0.1.0.jar) (Core Library)
...
*   [**FastTerminal**](https://github.com/andrestubbe/FastTerminal) — Multi-buffered True-Color console terminal rendering.
